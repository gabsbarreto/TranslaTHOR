...
def _build_job_settings(
    *,
    ...
    return {
        ...
        "use_previous_page_context_for_header_detection": DEFAULT_USE_PREVIOUS_PAGE_CONTEXT_FOR_HEADER_DETECTION,
        "previous_context_paragraphs": DEFAULT_PREVIOUS_CONTEXT_PARAGRAPHS,
        "max_previous_context_chars": DEFAULT_MAX_PREVIOUS_CONTEXT_CHARS,
        "translation_model": {
            "provider": "mlx",
