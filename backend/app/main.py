...
def _build_job_settings(
    *,
    ...
    return {
        ...
        "extract_document_metadata": DEFAULT_EXTRACT_DOCUMENT_METADATA,
        "extract_document_metadata_with_llm": DEFAULT_EXTRACT_DOCUMENT_METADATA_WITH_LLM,
        "metadata_extraction_model": DEFAULT_METADATA_EXTRACTION_MODEL,
        "metadata_extraction_max_input_chars": DEFAULT_METADATA_EXTRACTION_MAX_INPUT_CHARS,
        "metadata_extraction_max_tokens": DEFAULT_METADATA_EXTRACTION_MAX_TOKENS,
        "metadata_extraction_timeout_seconds": DEFAULT_METADATA_EXTRACTION_TIMEOUT_SECONDS,
        "clean_page_furniture_with_metadata": DEFAULT_CLEAN_PAGE_FURNITURE_WITH_METADATA,
        "metadata_cleanup_top_lines": DEFAULT_METADATA_CLEANUP_TOP_LINES,
        "metadata_cleanup_bottom_lines": DEFAULT_METADATA_CLEANUP_BOTTOM_LINES,
        "metadata_similarity_threshold": DEFAULT_METADATA_SIMILARITY_THRESHOLD,
        "preserve_first_page_metadata": DEFAULT_PRESERVE_FIRST_PAGE_METADATA,
        "translation_model": {
            "provider": "mlx",
