...
DEFAULT_DEEPSEEK_OCR_MODEL = "mlx-community/Qwen3.5-4B-4bit"
DEFAULT_DEEPSEEK_OCR_MAX_TOKENS = 4096
DEFAULT_DEEPSEEK_OCR_PROMPT = "convert this text to markdown"
...
DEFAULT_SELECTED_OCR_PRIMARY_SCALE = 0.75
DEFAULT_SELECTED_OCR_PRIMARY_JPEG_QUALITY = 75
